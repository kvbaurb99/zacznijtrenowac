...
const TRANSFORMATIONS: Transformation[] = [
  {
    ...
    name: "Anna Kowalska",
    description:
      "Minus 15kg w 6 miesięcy. Ania zmieniła nie tylko sylwetkę, ale przede wszystkim nawyki żywieniowe.",
    duration: "6 miesięcy",
    result: "-15kg",
  },
  {
    ...
    name: "Piotr Nowak",
    description:
      "Budowa masy mięśniowej od podstaw. Piotr zyskał pewność siebie i nową energię do życia.",
    duration: "8 miesięcy",
    result: "+8kg mięśni",
  },
  {
    ...
    description:
      "Powrót do formy po ciąży. Bezpieczny trening i dieta dostosowana do karmienia piersią.",
    duration: "4 miesiące",
    result: "-10kg",
  },
  {
    ...
    description:
      "Redukcja tkanki tłuszczowej i poprawa kondycji. Przygotowanie do pierwszego maratonu.",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <header className="flex flex-col items-center text-center mb-16">
          ...
          <p className="text-zinc-400 max-w-2xl text-lg">
            Zobacz, co możemy osiągnąć razem. To nie tylko zdjęcia, to historie
            ludzi, którzy zaufali nam i zmienili swoje życie.
          </p>
        </header>
