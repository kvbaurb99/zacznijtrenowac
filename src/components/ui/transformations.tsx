    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative max-w-[1400px] mx-auto">
          ...
          <button
            onClick={prev}
            className="absolute -left-5 lg:-left-6 top-1/2 -translate-y-1/2 z-20 p-3 lg:p-4 rounded-full bg-zinc-900/80 border border-zinc-800 text-zinc-400 hover:bg-white hover:text-zinc-900 hover:border-white transition-all duration-300 hidden md:flex shadow-xl backdrop-blur-sm"
          ...
          <button
            onClick={next}
            className="absolute -right-5 lg:-right-6 top-1/2 -translate-y-1/2 z-20 p-3 lg:p-4 rounded-full bg-zinc-900/80 border border-zinc-800 text-zinc-400 hover:bg-white hover:text-zinc-900 hover:border-white transition-all duration-300 hidden md:flex shadow-xl backdrop-blur-sm"
            aria-label="Następny"
          >
          ...
          >
            ...
            >
              {TRANSFORMATIONS.map((item, index) => (
                ...
                >
                  {/* Card */}
                  <div className="group relative rounded-2xl overflow-hidden bg-zinc-900 border border-zinc-800/50 hover:border-zinc-700/80 transition-all duration-500">
                    <div className="aspect-[4/5] relative">
                      ...
                      {/* Corner accents */}
                      <div className="absolute top-3 right-3 w-5 h-5 border-r border-t border-white/0 group-hover:border-white/30 rounded-tr-md transition-all duration-500 z-20" />
                      <div className="absolute bottom-3 left-3 w-5 h-5 border-l border-b border-white/0 group-hover:border-white/30 rounded-bl-md transition-all duration-500 z-20" />
                    </div>
                  </div>
                </div>
              ))}
